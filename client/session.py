...
SYSTEM_MESSAGE = (
    ...
    # "12. Make sure you ACTUALLY make the tool call, and ALWAYS EXECUTE IT instead of ending your turn\n\n"
    # "EXAMPLE:\n"
    ...
    # "if you decide to use quantity forecast for loesche, you dont need historical data, you just need input from user, carefully understand optional user input and do not ask twice if not provided"
